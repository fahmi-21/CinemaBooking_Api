...
{
    /// <inheritdoc />
    public partial class InitialCreateinNewServer : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CleaningBufferMinutes = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicableBranchId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Coupons_Branches_ApplicableBranchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShowtimeSeats_AspNetUsers_LockedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrCodePayload = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Status = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Coupons_ApplicableBranchId",
                table: "Coupons",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_SectionId_RowLabel_SeatNumber",
                table: "Seats",
                columns: new[] { "SectionId", "RowLabel", "SeatNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sections_HallId_DisplayOrder",
                table: "Sections",
                columns: new[] { "HallId", "DisplayOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sections_HallId_Name",
                table: "Sections",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShowtimeSeats_LockedByUserId",
                table: "ShowtimeSeats",
